...
<Dialog.Portal>
  ...
  <DialogPrimitive.Content
    ...
    {transitionConfig}
    class={cn(
      "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-neutral-700 bg-background p-6 shadow-lg duration-200 sm:rounded-none",
      className,
    )}
    {...$$restProps}
  >
